...
public enum ItemFrom {
	USE_PROP(1, "USE PROP") {// 使用道具

	},
	COMBINE_PART(2, "COMBINE PART") {// 合成配件

	},
	RESOLVE_PART(3, "RESOLVE PART") {// 分解配件

	},
	SALE_EQUIP(4, "SALE EQUIP") {// 出售装备

	},
	EAT_EQUIP(5, "EAT EQUIP") {// 吞装备

	},
	DRAW_EQUIP(6, "DRAW EQUIP") {// 抽装

	},
	COMBAT_PART(7, "COMBAT PART") {//合装备

	},
	PART_FORTUNE(8, "PART_FORTUNE") {// 极限单兵

	},
	DRAW_HERO(9, "DRAW_HERO") {// 进阶武将

	},
	BUY_HERO(10, "BUY_HERO") {// 招将

	},
	DECOMPOSE_HERO(11, "DECOMPOSE_HERO") {// 分解武将
	...
	private ItemFrom(int code, String msg) {
		this.code = code;
		this.msg = msg;
	}
